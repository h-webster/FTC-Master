...
import { ftcapi } from './hooks/useEventsData';
...
export function extractTeamData(teamData, returnData) {
    ...
    returnData.seasons[0].rookieYear = teamData.teamByNumber.rookieYear;
    returnData.seasons[0].sponsors = teamData.teamByNumber.sponsors;
...
export function extractTeamDataBULK(teamData, returnData) {
    let wins = 0;
    let losses = 0;
    let ties = 0;
